...
public class KeyboardInput implements KeyListener {
	...
	private static final int[] RELEVANT_KEYS = { KEY_W, KEY_A, KEY_CTRL, KEY_ENTER, KEY_S, KEY_D, KEY_CAPS_LOCK, KEY_SHIFT, KEY_UP_ARROW,
			KEY_DOWN_ARROW,KEY_ESCAPE, KEY_LEFT_ARROW, KEY_RIGHT_ARROW, KEY_I, KEY_J, KEY_K, KEY_P, KEY_L, KEY_NUMPAD_0, 
			KEY_NUMPAD_1, KEY_NUMPAD_5, KEY_NUMPAD_2, KEY_NUMPAD_3,  KEY_F1,  KEY_F2, KEY_F3};
