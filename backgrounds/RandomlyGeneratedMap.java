...
public class RandomlyGeneratedMap implements Background {
	...
	public RandomlyGeneratedMap() {
		int xStartingPoint = ROWS / 2;
		int yStartingPoint = COLS / 2;
		

		this.mapGenerator.generateMap(xStartingPoint, yStartingPoint);
