...
public class bullet_sprite_red implements DisplayableSprite {
	...
	public bullet_sprite_red(double centerX, double centerY, double velocityX, double velocityY) {
		...
		if (image == null) {
			try {
				image = ImageIO.read(new File("res/RedLaser.png"));
			}
			catch (IOException e) {
